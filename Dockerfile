...
RUN mkdir /note_vi_backend

WORKDIR /note_vi_backend
...
RUN chmod a+x scripts/postgres/*

# RUN find scripts/ -type f -name "*.sh" -exec chmod +x {} \;
# RUN find scripts/postgres/ -type f -exec chmod +x {} \;
CMD ["./scripts/start-dev.sh"]